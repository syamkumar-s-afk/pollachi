  ...
  const renderActions = () => (
    <div className="px-4 pb-4">
      <div className="flex flex-nowrap items-center gap-2 border-t border-gray-200 pt-3 justify-start sm:justify-end">
        <a
          href={`tel:${biz.phone}`}
          className="inline-flex min-w-0 flex-1 items-center justify-start gap-1.5 rounded-md bg-red-500 px-2.5 py-[9px] text-[10px] font-bold text-white shadow-sm transition-colors hover:bg-red-600 sm:flex-none sm:justify-center sm:px-3 sm:py-[11px] sm:text-sm"
        ...
        <a
          ...
          className="inline-flex min-w-0 flex-1 items-center justify-start gap-1.5 rounded-md bg-green-500 px-2.5 py-[9px] text-[10px] font-bold text-white shadow-sm transition-colors hover:bg-green-600 sm:flex-none sm:justify-center sm:px-3 sm:py-[11px] sm:text-sm"
        ...
        {mapUrl && (
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex min-w-0 flex-1 items-center justify-start gap-1.5 rounded-md bg-blue-500 px-2.5 py-[9px] text-[10px] font-bold text-white shadow-sm transition-colors hover:bg-blue-600 sm:flex-none sm:justify-center sm:px-3 sm:py-[11px] sm:text-sm"
        ...
        <button
          type="button"
          onClick={handleShare}
          className={`inline-flex h-[35px] w-[35px] shrink-0 items-center justify-center rounded-md transition-colors sm:h-[39px] sm:w-[39px] ${
            copied
