...
export default function Admin() {
  ...
  const fetchBusinesses = async () => {
    try {
      ...
      toast.error(
        'Failed to load',
        'Could not fetch business listings.'
      );
    }
  };
  ...
  const editBusiness = (b: Business) => {
    setForm({ ...b });
    setIsCustomCategory(
      b.category ? !CATEGORIES.includes(b.category as typeof CATEGORIES[number]) : false
    );
    setIsCustomSubCategory(
      b.sub_category
        ? !ALL_SUB_CATEGORIES.includes(b.sub_category as typeof ALL_SUB_CATEGORIES[number])
        : false
    );
    setIsCustomCity(
  ...
  return (
    <div className="space-y-6">
      {/* Header Bar */}
      <div className="bg-white p-5 rounded-xl shadow-sm border border-[var(--color-border)] flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            ...
            <form onSubmit={handleSubmit} className="space-y-3.5 text-sm">
              ...
              <div>
                ...
                {isCustomCategory && (
                  <input
                    ...
                    className={inputClass('category') + ' mt-2'}
                  />
                )}
                {errors.category && (
              ...
              <div>
                ...
                <select
                  id="biz-subcategory"
                  value={
                    isCustomSubCategory ? 'Others' : form.sub_category
                  }
                  onChange={(e) => {
                    if (e.target.value === 'Others') {
                  ...
                  className={inputClass('sub_category') + ' cursor-pointer'}
                >
                ...
                {isCustomSubCategory && (
                  <input
                    ...
                    className={inputClass('sub_category') + ' mt-2'}
                  />
                )}
                {errors.sub_category && (
                  <p className="text-xs text-red-500 mt-1">
              ...
              <div>
                ...
                <input
                  ...
                  value={form.adId}
                  onChange={(e) =>
                    setForm({ ...form, adId: e.target.value })
                  }
